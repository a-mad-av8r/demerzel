  ...
  import: {
    ...
    connection: {
      ...
      gptLoadUrlDescription:
        'Demerzel ゲートウェイのルートまたはデプロイ接頭辞を入力します（例: https://demerzel.example.com）。/v1 や /v1beta などの標準プロトコルパスは含めないでください。',
    ...
    credentials: {
      ...
      accessKeyWarning: '{count} 行が Demerzel アクセスキーのようです — 続行前に確認してください',
