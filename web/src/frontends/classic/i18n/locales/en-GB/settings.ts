...
export default {
  ...
  settings: {
    ...
    runtime: {
      ...
      models_dev_auto_sync_enabled: 'Automatically sync the Models.dev catalogue and prices',
    ...
    browserAccess: {
      ...
      cors: {
        ...
        enabled: 'Enable CORS',
        enabledHelp: 'When disabled, existing OPTIONS and authentication behaviour is preserved.',
        ...
        disabledSummary: 'CORS is disabled; OPTIONS keeps its existing behaviour.',
      },
      responseHeaders: {
