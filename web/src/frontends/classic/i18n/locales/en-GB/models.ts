export default {
  models: {
    ...
    actions: {
      sync: 'Sync catalogue and automatic prices',
      configureGroups: 'Add models in Groups',
    },
    sync: {
      succeeded: 'The model catalogue and automatic prices are synced',
      failed: 'Unable to sync the model catalogue and prices',
    },
    status: {
    ...
    catalog: {
      available: 'Preset price catalogue available',
      stale: 'Models.dev sync failed; using the current price catalogue',
      unavailable: 'Price catalogue unavailable',
    ...
    inspector: {
      noCatalog: 'No catalogue metadata',
    },
    drawer: {
    ...
    detail: {
      ...
      catalogReference: {
        actual_provider: 'Price catalogue provider · {provider}',
        reference_provider: 'Price catalogue reference provider · {provider}',
      },
      specs: {
        context: 'Context',
        maxInput: 'Max input',
