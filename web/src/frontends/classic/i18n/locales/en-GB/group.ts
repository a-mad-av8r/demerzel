export default {
  ...
  group: {
    ...
    modelEditor: {
      ...
      sources: { catalog: 'Catalogue', live: 'Live discovery' },
      drawer: {
      ...
      sync: {
        ...
        title: 'Sync models',
        description:
          'The list combines live discovery and the pricing catalogue. Sync uses only live discovery, so catalogue-only models may appear in the removal list.',
    ...
    credentials: {
      ...
      subscription: {
        ...
        connectDescription:
          'Sign in with the upstream subscription service; the account joins this group automatically once authorised.',
        ...
        account: {
          ...
          seatTier: 'Seat tier',
          organizationRateLimitTier: 'Organisation quota tier',
        ...
        observationError: {
          ...
          authorizationFailed:
            'The upstream subscription authorisation is no longer valid. Sign in again.',
          partial:
          ...
          payloadInvalid: 'The upstream returned unrecognised subscription entitlement information',
        },
        status: {
          available: 'Available',
      ...
      full: {
        ...
        restoreDescription:
          'Clear all model cooldowns for this Group’s {kind} and restore eligible credentials in cooldown or on the blacklist. Keep enabled and authorisation states and historical statistics. Upstream quotas are unchanged. Applies across all search results, filters, and pages.',
        confirm: {
          download: 'Download all',
          enable: 'Enable all',
          disable: 'Disable all',
