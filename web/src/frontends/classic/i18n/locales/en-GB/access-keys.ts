export default {
  accessKeys: {
    customKey: {
      ...
      replaceWeakWarning:
        'The new key is weak and easy to guess, which may allow unauthorised requests and quota consumption.',
      ...
      warningDescription:
        'This key is easy to guess and may allow unauthorised requests and quota consumption. Consider changing it or leaving the field blank to generate a random key.',
    ...
    drawer: {
      ...
      sourceIPDescription: 'Restrict the address that connects directly to Demerzel.',
      ...
      groupOptionsLoading: 'Loading Group catalogue…',
      selectedCount: '{count} selected',
      clearSelected: 'Clear selected',
      removeSelection: 'Remove {label}',
      groupProtocolMismatch: 'The selected Groups and protocols have no routable overlap.',
      modelRouteRisk:
        'A selected model is not in the current Group catalogue, so requests may fail to route.',
      ...
      saveBlockedGroupUnavailable: 'Group catalogue unavailable',
      ...
      groupScopeUnavailable:
        'Group scope cannot be changed until the Group catalogue is available again.',
      staleGroupScopeInvalid:
        'Stale Group data can only retain or remove Groups already authorised by this access key.',
    },
    delete: {
      open: 'Delete',
